# Questão 04) Crie uma lista chamada números, peça para o usuário inserir 5 números e alimente essa lista, depois mostre o dobro de todos os números na tela de forma separada.
...
# Utilizando o operador de associação "in" e utilizando a estrutura de repetição FOR para percorrer sobre a lista. Imprimindo no final o dobro dos números digitados pelo usuário.
for dobro in lista_numeros:
    print(f'O dobro do número {dobro} é: {dobro *2}')